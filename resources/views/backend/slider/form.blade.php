        ...
        <div class="card-body">
          <div class="form-body">
            <div class="form-group">
              ...
              <input type="file" name="slider_img" class="dropify @error('slider_img') is-invalid @enderror" data-max-file-size-preview="8M" @if (isset($slider->slider_img)) data-default-file="{{ asset($slider->slider_img) }}" @endif
