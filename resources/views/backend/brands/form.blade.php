        ...
        <div class="card-body">
          <div class="form-body">
            <div class="form-group">
              ...
              <input type="file" name="image" class="dropify @error('image') is-invalid @enderror" data-max-file-size-preview="8M" @if (isset($brand->image)) data-default-file="{{ asset($brand->image) }}" @endif
