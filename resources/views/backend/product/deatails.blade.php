        ...
        <div class="form-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="file" class="dropify" data-width="100" data-default-file="{{ asset($product->image) }}" disabled />
            </div>
            @forelse ($product->multi_images as $key=> $multiImage)
            <div class="col-md-3">
              <label class="col-form-label">Multi image {{ $key+1 }}</label>
              <input type="file" class="dropify" data-width="150" data-default-file="{{ asset($multiImage->image_name) }}" disabled />
            </div>
            @empty
            @endforelse
          </div>
